  ...
  return (
    <footer className='footer-container relative'>
      ...
      <div className='mx-auto max-w-7xl px-6 pb-8 pt-16  lg:px-8'>
        ...
        <div className='w-full text-center bg-amber-100 text-amber-900 my-4 text-xs py-2 px-4 animate-marquee whitespace-nowrap overflow-hidden'>
          <span>
        ...
        <div className='mt-16 border-t border-gray-900/10 pt-4 sm:mt-20 lg:mt-24'>
