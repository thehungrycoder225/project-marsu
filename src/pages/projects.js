const projects = [
    {
        ...
        description: 'The iUgnay Project aims to bridge the digital divide in remote Marinduque villages using satellite technology to provide high-speed internet access and enhance educational and economic opportunities for residents.',
    ...
    },
    {
        ...
        description: 'The project aims to establish a breeder farm, which will be a sustainable and eligible source of quality poultry stocks to be made made available to local farmers to support their livelihoods and improve their income.',
        ...
        objectives: ['The project aims to establish a breeder farm, which will be a sustainable and eligible source of quality poultry stocks to be made available to local farmers to support their livelihoods and improve their income.'],
        subject: [
            {
                initiator: 'Marinduque State University',
                leader: 'Prof. Dr. Diosdado P. Zulueta',
                members: ['1. Project Leader: Mr. Adrian S. Mausig',
        ...
        environment: [
            {
                nature: 'Small-island farming communities facing challenges in accessibility to agricultural inputs, food supply, and livelihood opportunities',
                industry: 'Poultry and livestock sectors dominated by backyard producers',
                government: 'National and local government agencies/units supportive of the promotion of agricultural productivity and competitiveness ',
            },
        ],
        resources: [
            {
                ...
                technical: ['Farm equipment and tools', 'Poultry parents stocks', 'Poultry houses', 'Poultry feeds and biologics'],
            },
        ],
        mechanism: [
            {
        ...
        progress: ['Sustained operations of the poultry farm', 'Utilization of the poultry farm for instruction', 'Regular monitoring of the beneficiaries'],
        problems: ['Recurring power interruptions that affect incubation and brooding leading to high mortality', 'High mortality of dispersed stocks'],
        solution: ['Regular monitoring to determine the causes of mortality', 'Provision of management recommendations to the beneficiaries'],
        completion: 'Ongoing',
        impact: ['Hands-on experience in poultry production and management'],
        output: ['166 farmers trained 146 students trained', '243 beneficiaries of the stock dispersal program', '3373 heads of stocks dispersed', 'Php 629, 385.62 total value of stocks dispersed'],
        costing: 'N/A',
        future: 'There is a project proposal submitted to the Department of Agriculture - Agricultural Competitiveness Enhancement Fund to secure additional funding. The project will also engage in technology commercialization by tapping a farmers’ association to be capacitated on the commercial production of free-range chicken.'
    },

    {
        id: 4,
        title: 'G.R.A.C.E. -  A Training Program for Barangay Officials',
        description: 'The project aims to provide training and development opportunities for barangay officials in Santa Cruz, Marinduque, to enhance their skills and competencies in local governance and administration.',
...
`,
        ...
        objectives: ['To mitigate the existing gaps among barangay officials elected and appointed officials in the 55 barangays of Santa Cruz to promote efficiency, effectiveness, and competency for local governance and administration', 'To advocate high performance on selected skills among elected and appointed officials in the 55 barangays of Santa Cruz for local governance and administration.'],
        subject: [
            {
                initiator: 'Profugo, Joy',
                leader: 'Profugo, Joy',
                members: ['Imperio, Wilmer II', 'Malabayabas, Keam Eric', ' De Mesa, Katrina', 'Rodil, Neil Ryan', 'Monteagudo, Jayceron'],
            }
        ],
        environment: [
            {
                nature: 'Bachelor of Arts in Political Science, BS in Public Adm, BS Law Enforcement Adm./ Local Government Units (Barangays)',
                industry: 'N/A',
                government: 'National and local government agencies/units supportive of the promotion of agricultural productivity and competitiveness ',
            },
        ],
        resources: [
            {
                human: ['55 Punong Barangay', '55 Secretaries', '55 Treasurers', '385 Barangay Kagawad'],
                financial: ['Fully funded by Liga ng mga Barangay - P600,000.00'],
                technical: ['Multimedia equipment (MarSU) ', 'Sound System (Liga ng mga Barangay)', 'Digital Modules (MarSU)', 'Resource Speakers from MarSU (BA PolSc., Public Adm., BS Law Enforcement)'],
            },
        ],
        mechanism: [
            {
        ...
        proponent: 'Department of the Interior and Local Government, Municipal Local Government Office of Sta. Cruz, and Liga ng mga Barangays',
        ...
        impact: ['Exposure of the barangay problems among students',
            ...
            'Module development'],
        output: ['A well-developed Barangay Development Plan', 'A well-planned project proposals', 'A well-written minutes of the meeting applying Records Management System', 'A well-executed meeting using Parliamentary Practice and Procedure', 'A well-implemented barangay laws and order and other government policies.'],
        future: 'Transfer of knowledge from one barangay to other barangays and one municipality to other municipalities'
    },
