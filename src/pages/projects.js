const projects = [
  {
    ...
    description:
      'The iUgpong Project aims to bridge the digital divide in remote Marinduque villages using satellite technology to provide high-speed internet access and enhance educational and economic opportunities for residents.',
